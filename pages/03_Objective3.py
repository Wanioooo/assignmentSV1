...
# ===============================
st.header("Summary Overview", divider="blue")
with st.container(border=True):
    st.markdown("""
    **Summary:**  
    This section provides an overview of how academic challenges and engagement factors — such as **teacher consultancy attendance**, **English proficiency**, and **skill development commitment** — influence students' academic outcomes.  
    The following metrics summarize the main findings before diving into visual analysis.
    """)

# ===============================
# Key Metric Summary Section
# ===============================
...
col_p.metric(
    ...
    f"{probation_rate:.1f}%",
    help="Percentage of students who reported falling on academic probation."
)

# 2. Consultancy CGPA Impact
...
# English Proficiency Probation Breakdown
...
# ===============================
st.header("Visualizations and Interpretations", divider="orange")
